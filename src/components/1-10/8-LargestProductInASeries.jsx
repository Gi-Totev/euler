...
const LargestProductInASeries = ({ classes }) => {
  ...
  return (
    <InputBox
      ...
      onClick={getProduct}
      result={result}
      resultText={`The max product of ${endNumber} numbers in the 1000 digits series is:`}
    />
  );
};

export default LargestProductInASeries;
